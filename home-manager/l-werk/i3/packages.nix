...
bindsym $mod+o exec remmina -c "$(ls /home/deadbeef/.local/share/remmina/*$(echo -n ${config.sops.placeholder.remminaOfficeIP} | sed 's|\.|-|g')*)"
bindsym $mod+p exec remmina -c "$(ls /home/deadbeef/.local/share/remmina/*$(echo -n ${config.sops.placeholder.remminaPentestIP} | sed 's|\.|-|g')*)"
