          ...
          map (
            ...
            in
            {
              ...
              value =
                ...
                # ─────────────────────────────
                // (lib.optionalAttrs (kind == "p2p" && !(ep ? addr4)) {
                  addr4 = addr.mkP2P4 {
                    v4Base = tenantV4Base;
                    vlanId = l.vlanId;
                    node = n;
                ...
                // (lib.optionalAttrs (kind == "p2p" && !(ep ? addr6)) {
                  addr6 = addr.mkP2P6 {
                    ulaPrefix = ulaPrefix;
                    vlanId = l.vlanId;
                    node = n;
                ...
                # ─────────────────────────────
                // (lib.optionalAttrs (kind == "lan" && isGw && !(ep ? addr4)) {
                  addr4 = addr.mkTenantV4 {
                    v4Base = tenantV4Base;
                    vlanId = l.vlanId;
                  };
                })
                // (lib.optionalAttrs (kind == "lan" && isGw && !(ep ? addr6)) {
