...
let
  ...
  payload = stdenv.mkDerivation rec {
    ...
    src = fetchurl {
      url = "https://linux.dell.com/repo/hardware/dsu/os_independent/x86_64/dell-system-update-2.3.0.1-26.08.00.x86_64.rpm";
      hash = "sha256-iX+Rzd/+1C1dq3L7NakDuCPNCfV5BMaZia4eyJujTM8=";
    };
