...
```bash
sed -i 's|/home/deadbeef/github/nixos|<your-new-path>|g' /home/deadbeef/github/nixos/nixos/l-esp/README.md
sed -i 's/192.168.1.124/<your-new-ip>/g' /home/deadbeef/github/nixos/nixos/l-esp/README.md
```
...
rsync -va /home/deadbeef/github/nixos nixos@192.168.1.124:~/github/
```

```bash
# inside the vm:
PATH_TO_DISKO="/home/nixos/github/nixos/nixos/l-esp/disko/build_disko.nix"
...
```bash
# host that contain the nixos configuration:
rsync -va nixos@192.168.1.124:/mnt/etc/nixos/hardware-configuration.nix /home/deadbeef/github/nixos/nixos/l-esp/hardware/hardware-configuration.nix
```
...
```bash
# disable the lxc.nix file, it fails if the user is not made yet.
sed -i 's|../1-general/virtualization/lxc.nix||g' /home/nixos/github/nixos/nixos/l-esp/configuration.nix
nix --extra-experimental-features 'nix-command flakes' run github:NixOS/nixpkgs/nixos-24.11#nixos-install -- --impure --flake path:/home/nixos/github/nixos#l-esp
# .....
...
rsync -va /home/deadbeef/github/nixos deadbeef@192.168.1.124:~/github/
