...
let
  mkMgmt = import ../../../../10-vms/nixos-shell-vm/../../10-vms/nixos-shell-vm/1-helpers/mk-management-networkd.nix { inherit lib pkgs; };
  mkBridge = import ../../../../10-vms/nixos-shell-vm/../../10-vms/nixos-shell-vm/1-helpers/mk-bridge-networkd.nix { inherit lib pkgs; };
in
{
  imports = [
