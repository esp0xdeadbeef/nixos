...
let
  udpListener = port: "${pkgs.socat}/bin/socat -u UDP6-LISTEN:${toString port},reuseaddr,fork -";

  dmzClient = name: address: extra: {
    autoStart = true;
    privateNetwork = true;
    hostBridge = "dmz";
