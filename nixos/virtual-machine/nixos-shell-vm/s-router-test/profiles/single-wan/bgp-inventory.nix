...
in
{
  endpoints = {
    ...
    wireguard01 = {
      ipv4 = [ "10.20.30.11" ];
      ipv6 = [ "fd42:dead:beef:30::11" ];
    };

    dmzweb01 = {
      ipv4 = [ "10.20.30.12" ];
      ipv6 = [ "fd42:dead:beef:30::12" ];
    };
  };
    ...
    nodes = {
        ...
        advertisements = {
          dhcp4 = {
            tenant-dmz = {
              ...
              router = "10.20.30.1";
              dnsServers = accessDns.dmz.advertised.dnsServers;
              domain = "lan.";
            };
          };
          ...
          ipv6Ra = {
            tenant-dmz = {
              ...
              rdnss = accessDns.dmz.advertised.rdnss;
              dnssl = [ "lan." ];
            };
          };
        };
      ...
      esp0xdeadbeef-site-a-s-router-policy = {
        ...
        ports = {
          ...
          upstream-dmz = {
            link = "p2p-s-router-policy-only-s-router-upstream-selector--access-s-router-access-dmz--uplink-wan";
            attach = {
              kind = "bridge";
              bridge = "tr204";
            };
