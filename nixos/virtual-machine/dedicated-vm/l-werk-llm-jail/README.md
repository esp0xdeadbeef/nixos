...
```bash
sed -i 's|/home/deadbeef/github/nixos/nixos/virtual-machine/dedicated-vm/l-werk-llm-jail/|<your-new-path>|g' /home/deadbeef/github/nixos/nixos/virtual-machine/dedicated-vm/l-werk-llm-jail/virtual-machine/dedicated-vm/l-werk-llm-jail/README.md
sed -i 's/192.168.1.164/<your-new-ip>/g' /home/deadbeef/github/nixos/nixos/virtual-machine/dedicated-vm/l-werk-llm-jail/README.md
```
...
```bash
# inside the vm:
PATH_TO_DISKO="/home/nixos/github/nixos/nixos/virtual-machine/dedicated-vm/l-werk-llm-jail/disko.nix"
...
Run afterwards:
```bash
(cd ~/github/nixos/secrets/ ; sops updatekeys l-werk-llm-jail.yaml)
```
...
```bash
nix --extra-experimental-features 'nix-command flakes' run github:NixOS/nixpkgs/nixos-25.11#nixos-install -- --impure --flake path:/home/nixos/github/nixos#l-werk-llm-jail
reboot
```
