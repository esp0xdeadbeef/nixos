...
in
{
  options.local = {
    ...
    tilingManagerSettings.statusBarFont = lib.mkOption {
      type = lib.types.str;
      default = "pango:JetBrainsMono Nerd Font Mono, DejaVu Sans Mono, Font Awesome 6 Free Solid, Font Awesome 6 Free Regular, Font Awesome 6 Brands Regular, Noto Color Emoji 11";
